...
class Quaternion:
    ...
    def __init__(self, w_or_q, x=None, y=None, z=None):
        ...
        Quaternionオブジェクトを初期化します
         ：param w_or_q：四元数の実部、別のQuaternionオブジェクト、またはを表すスカラー
                     四元数の値を含む4要素の配列
         ：param x：w_or_qがスカラーの場合、最初の虚数部
         ：param y：w_or_qがスカラーの場合、2番目の虚数部
         ：param z：w_or_qがスカラーの場合、3番目の虚数部
        """
    ...
    # Quaternion specific interfaces 四元数固有のインターフェース
...
         ：return：四元数の共役
    ...
    def to_angle_axis(self):
        ...
        オイラー角と軸で表されるクォータニオンの回転を返します。
         四元数が恒等四元数（1、0、0、0）の場合、角度0のx軸に沿った回転が返されます。
         ：return：rad、x、y、z
        """
    ...
    def __mul__(self, other):
        ...
        与えられた四元数を他の四元数またはスカラーと乗算する
         ：param other：クォータニオンオブジェクトまたは数
         ：return：
        """
    ...
    def __add__(self, other):
        ...
        要素ごとに2つのクォータニオンを追加するか、クォータニオンの各要素にスカラーを追加します。
         その他のparam
         ：return：
        """
    ...
    # Implementing other interfaces to ease working with the class クラスでの作業を容易にするために他のインターフェースを実装する
